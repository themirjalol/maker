...
# ==================== KONFIGURATSIYA ====================
# Admin sozlamalari
ADMIN_ID = os.getenv('ADMIN_ID', "5873723609")
TOKEN = os.getenv('BOT_TOKEN', "8272272306:AAHclI4n-FLjA1uTyz7YwEgKvZebPiiEW0g")

# Ma'lumotlar bazasi konfiguratsiyasi
DB_CONFIG = {
    'host': os.getenv('DB_HOST', 'localhost'),
    'database': os.getenv('DB_NAME', 'bot_manager_db'),
